class InverterDO:
    ...
    def __init__(self, name, iec_inverter_name, nominal_power_wac, maximum_power_kwac, total_dc_power,
                 states_and_fault_codes, manufacturer, model, firmware_version, dc_input_capacity,
                 number_of_connected_combiners, module_manufacturer):
        self.name = name
        self.iec_inverter_name = iec_inverter_name
